...
\book {
  \bookOutputName "divino_maravilhosos_Eb"
  \header {
...
\book {
  \bookOutputName "divino_maravilhosos_C"
  \header {
...
\book {
  \bookOutputName "divino_maravilhosos_C_clave_Fa"
  \header {
     instrument = "Para instrumentos em C"
  }
  \score {
...
\book {
  \bookOutputName "divino_maravilhosos_Bb"
  \header {
...
\book {
  \bookOutputName "divino_maravilhosos_Eb_notas"
  \header {
     instrument = "Eb"
  }
  \score {
